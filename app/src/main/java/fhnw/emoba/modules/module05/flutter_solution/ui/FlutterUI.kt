package fhnw.emoba.modules.module05.flutter_solution.ui
...
import fhnw.emoba.modules.module05.flutter_solution.ui.theme.lightBlue900


@Composable
fun FlutterUI(model: FlutterModel) {
    MaterialTheme(colors = lightColors(primary = lightBlue900)) {
...
private fun AllFlapsPanel(flaps: List<Flap>, modifier: Modifier){
    Box(modifier.border(width = 1.dp,
        ...
        if(flaps.isEmpty()){
            ...
            ScrollableColumn (scrollState = scrollState){ flaps.forEach { FlapView(it) } }
